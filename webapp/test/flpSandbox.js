					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Different type of charts display using dropdown",
									"targetURL": "#r8charts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"r8charts-display": {
								"semanticObject": "r8charts",
								"action": "display",
								"description": "Different type of charts display using dropdown",
								"title": "Different type of charts display using dropdown",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=r8charts",
									"url": sap.ui.require.toUrl("r8charts")
								}
							}
						}
					}
